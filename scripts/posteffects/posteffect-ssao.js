...
class SSAOEffect extends pc.PostEffect {
    constructor(graphicDevice, ssaoScript) {
        super(graphicDevice);
        ...
        this.ssaoShader = pc.createShaderFromCode(graphicDevice, pc.PostEffect.quadVertexShader, fSsao, 'SsaoShader', attributes);
        this.blurShader = pc.createShaderFromCode(graphicDevice, pc.PostEffect.quadVertexShader, fblur, 'SsaoBlurShader', attributes);
        this.outputShader = pc.createShaderFromCode(graphicDevice, pc.PostEffect.quadVertexShader, foutput, 'SsaoOutputShader', attributes);
